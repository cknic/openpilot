...
class CarControllerParams:
  ...
  ANGLE_ACTIVE_TORQUE_REDUCTION_GAIN = 1.0  # Torque command for angle steering - full authority for responsive lane keeping.
...
class CAR(Platforms):
  ...
  KIA_CARNIVAL_4TH_GEN = HyundaiCanFDPlatformConfig(
    ...
    flags=HyundaiFlags.RADAR_SCC | HyundaiFlags.CANFD_ANGLE_STEERING | HyundaiFlags.CANFD_ALT_BUTTONS,
  )
